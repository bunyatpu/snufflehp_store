            ...
            <Grid.Row width="2" verticalAlign="middle">
              ...
              <Grid.Column width="8" textAlign="left">
                <Button  
                  loading={saving}
                  color='teal'
                  onClick={handleSubmit(this.onSaveUser)}
                  >
                  บันทึก
                </Button>
              </Grid.Column>
        ...
        <Grid container style={{marginTop:'20px'}}>
          <Grid.Row >
            <Grid.Column  width="4" style={{paddingRight:'3px'}} >
              <Header as='h4' style={{height:'29px'}}>สวัสดี, {userInf.userName}</Header>
              <Divider clearing />
...
export default connect(mapStateToProps,{change,updateUser})(reduxForm({form:'userInfo',validate})(User))